...
<h1 class="page-title">Events{% if site_id %} — {{ site.name }}{% endif %}</h1>
<div class="card">
...
(function () {
  ...
  async function load() {
    const data = await api("/api/events?limit=300" + (SITE ? "&site=" + SITE : ""));
